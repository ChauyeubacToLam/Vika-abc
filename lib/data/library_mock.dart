...
const List<AllExerciseRowMock> libraryMockAllExercises = [
  ...
  AllExerciseRowMock(
    idx: 13,
    name: 'Bird Dog',
    cat: 'Bài tập · Tuỳ chọn',
    diff: 'Trung bình',
    ai: true,
    glyph: PoseGlyphType.plank,
    definitionName: 'bird__dog',
    yoga: false,
    group: 'BÀI TẬP',
  ),
  AllExerciseRowMock(
  ...
  AllExerciseRowMock(
    ...
    ai: true,
    glyph: PoseGlyphType.plank,
    definitionName: 'plank__up__down',
    yoga: false,
    group: 'BÀI TẬP',
  ),
  AllExerciseRowMock(
  ...
  AllExerciseRowMock(
    ...
    ai: true,
    glyph: PoseGlyphType.plank,
    definitionName: 'mountain__climber',
    yoga: false,
    group: 'BÀI TẬP',
  ),
  AllExerciseRowMock(
  ...
  AllExerciseRowMock(
    ...
    ai: true,
    glyph: PoseGlyphType.plank,
    definitionName: 'plank__shoulder__tap',
    yoga: false,
    group: 'BÀI TẬP',
  ),
  AllExerciseRowMock(
  ...
  AllExerciseRowMock(
    ...
    ai: true,
    glyph: PoseGlyphType.plank,
    definitionName: 'reverse__crunch',
    yoga: false,
    group: 'BÀI TẬP',
  ),
  AllExerciseRowMock(
  ...
  AllExerciseRowMock(
    ...
    ai: true,
    glyph: PoseGlyphType.plank,
    definitionName: 'butterfly__stretch',
    yoga: true,
    group: 'YOGA',
  ),
  AllExerciseRowMock(
  ...
  AllExerciseRowMock(
    ...
    ai: true,
    glyph: PoseGlyphType.plank,
    definitionName: 'seated__forward__fold',
    yoga: false,
    group: 'BÀI TẬP',
  ),
  AllExerciseRowMock(
    ...
    ai: true,
    glyph: PoseGlyphType.plank,
    definitionName: 'side__plank_with__hip__dip',
    yoga: false,
    group: 'BÀI TẬP',
  ),
  AllExerciseRowMock(
  ...
  AllExerciseRowMock(
    ...
    ai: true,
    glyph: PoseGlyphType.plank,
    definitionName: 'standing__knee_to__elbow',
    yoga: false,
    group: 'BÀI TẬP',
  ),
  AllExerciseRowMock(
    ...
    ai: true,
    glyph: PoseGlyphType.plank,
    definitionName: 'step__back__burpee',
    yoga: false,
    group: 'BÀI TẬP',
  ),
  AllExerciseRowMock(
    ...
    ai: true,
    glyph: PoseGlyphType.plank,
    definitionName: 'tricep__dip_(_floor)',
    yoga: false,
    group: 'BÀI TẬP',
  ),
  AllExerciseRowMock(
  ...
  AllExerciseRowMock(
    idx: 46,
    name: 'Wall Push Up',
    cat: 'Ngực · Vai · Tuỳ chọn',
    diff: 'Dễ',
    ai: true,
    glyph: PoseGlyphType.wallPushUp,
    definitionName: 'wall_push_up',
    yoga: false,
    group: 'NGỰC · VAI',
  ),
  AllExerciseRowMock(
  ...
  AllExerciseRowMock(
    ...
    ai: true,
    glyph: PoseGlyphType.plank,
    definitionName: 'ashtanga_namaskara',
    yoga: true,
    group: 'YOGA',
  ),
  AllExerciseRowMock(
