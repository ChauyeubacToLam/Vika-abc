...
const List<AllExerciseRowMock> libraryMockAllExercises = [
  ...
  AllExerciseRowMock(idx: 19, name: 'Chào mặt trời 1', cat: 'Yoga · Toàn thân · 5 vòng', diff: 'Trung bình', ai: true, yoga: true, glyph: PoseGlyphType.lunge, definitionName: 'Chào mặt trời 1'),
  AllExerciseRowMock(idx: 38, name: 'Chào mặt trời 2', cat: 'Yoga · Toàn thân · 5 vòng', diff: 'Trung bình', ai: true, yoga: true, glyph: PoseGlyphType.lunge, definitionName: 'Chào mặt trời 2'),
  AllExerciseRowMock(idx: 39, name: 'Chào mặt trời 3', cat: 'Yoga · Toàn thân · 5 vòng', diff: 'Trung bình', ai: true, yoga: true, glyph: PoseGlyphType.lunge, definitionName: 'Chào mặt trời 3'),
  AllExerciseRowMock(idx: 40, name: 'Chào mặt trời 4', cat: 'Yoga · Toàn thân · 5 vòng', diff: 'Trung bình', ai: true, yoga: true, glyph: PoseGlyphType.lunge, definitionName: 'Chào mặt trời 4'),
  AllExerciseRowMock(idx: 41, name: 'Chào mặt trời 5', cat: 'Yoga · Toàn thân · 5 vòng', diff: 'Trung bình', ai: true, yoga: true, glyph: PoseGlyphType.lunge, definitionName: 'Chào mặt trời 5'),
  AllExerciseRowMock(idx: 42, name: 'Chào mặt trời 6', cat: 'Yoga · Toàn thân · 5 vòng', diff: 'Trung bình', ai: true, yoga: true, glyph: PoseGlyphType.lunge, definitionName: 'Chào mặt trời 6'),
  AllExerciseRowMock(idx: 43, name: 'Chào mặt trời 7', cat: 'Yoga · Toàn thân · 5 vòng', diff: 'Trung bình', ai: true, yoga: true, glyph: PoseGlyphType.lunge, definitionName: 'Chào mặt trời 7'),
  AllExerciseRowMock(idx: 44, name: 'Chào mặt trời 8', cat: 'Yoga · Toàn thân · 5 vòng', diff: 'Trung bình', ai: true, yoga: true, glyph: PoseGlyphType.lunge, definitionName: 'Chào mặt trời 8'),
  AllExerciseRowMock(idx: 45, name: 'Chào mặt trời 9', cat: 'Yoga · Toàn thân · 5 vòng', diff: 'Trung bình', ai: true, yoga: true, glyph: PoseGlyphType.lunge, definitionName: 'Chào mặt trời 9'),
  AllExerciseRowMock(idx: 46, name: 'Chào mặt trời 10', cat: 'Yoga · Toàn thân · 5 vòng', diff: 'Trung bình', ai: true, yoga: true, glyph: PoseGlyphType.lunge, definitionName: 'Chào mặt trời 10'),
  AllExerciseRowMock(idx: 47, name: 'Chào mặt trời 11', cat: 'Yoga · Toàn thân · 5 vòng', diff: 'Trung bình', ai: true, yoga: true, glyph: PoseGlyphType.lunge, definitionName: 'Chào mặt trời 11'),
  AllExerciseRowMock(idx: 48, name: 'Chào mặt trời 12', cat: 'Yoga · Toàn thân · 5 vòng', diff: 'Trung bình', ai: true, yoga: true, glyph: PoseGlyphType.lunge, definitionName: 'Chào mặt trời 12'),
  AllExerciseRowMock(
    idx: 20,
