...
class KneeBendMetric extends Cmt2MetricBase {
  @override
  ...
  void update(Cmt2Context ctx) {
    final isActive = ctx.state == Cmt2State.p3_hastapaadasana ||
        ctx.state == Cmt2State.p10_hastapaadasana_return;
    if (!isActive) return;

    final isKneeBent = ctx.kneeAngle < Cmt2Config.KNEE_STRAIGHT_MIN;
