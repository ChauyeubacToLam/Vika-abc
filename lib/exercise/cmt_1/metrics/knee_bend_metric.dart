...
class KneeBendMetric extends Cmt1MetricBase {
  @override
  ...
  void update(Cmt1Context ctx) {
    final isActive = ctx.state == Cmt1State.p3_hastapaadasana ||
        ctx.state == Cmt1State.p10_hastapaadasana_return;
    if (!isActive) return;

    final isKneeBent = ctx.kneeAngle < Cmt1Config.KNEE_STRAIGHT_MIN;
