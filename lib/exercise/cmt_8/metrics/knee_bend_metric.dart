...
class KneeBendMetric extends Cmt8MetricBase {
  @override
  ...
  void update(Cmt8Context ctx) {
    final isActive = ctx.state == Cmt8State.p3_hastapaadasana ||
        ctx.state == Cmt8State.p10_hastapaadasana_return;
    if (!isActive) return;

    final isKneeBent = ctx.kneeAngle < Cmt8Config.KNEE_STRAIGHT_MIN;
