...
class KneeBendMetric extends Cmt4MetricBase {
  @override
  ...
  void update(Cmt4Context ctx) {
    final isActive = ctx.state == Cmt4State.p3_hastapaadasana ||
        ctx.state == Cmt4State.p10_hastapaadasana_return;
    if (!isActive) return;

    final isKneeBent = ctx.kneeAngle < Cmt4Config.KNEE_STRAIGHT_MIN;
