...
class KneeBendMetric extends Cmt7MetricBase {
  @override
  ...
  void update(Cmt7Context ctx) {
    final isActive = ctx.state == Cmt7State.p3_hastapaadasana ||
        ctx.state == Cmt7State.p10_hastapaadasana_return;
    if (!isActive) return;

    final isKneeBent = ctx.kneeAngle < Cmt7Config.KNEE_STRAIGHT_MIN;
