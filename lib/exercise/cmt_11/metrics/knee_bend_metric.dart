...
class KneeBendMetric extends Cmt11MetricBase {
  @override
  ...
  void update(Cmt11Context ctx) {
    final isActive = ctx.state == Cmt11State.p3_hastapaadasana ||
        ctx.state == Cmt11State.p10_hastapaadasana_return;
    if (!isActive) return;

    final isKneeBent = ctx.kneeAngle < Cmt11Config.KNEE_STRAIGHT_MIN;
