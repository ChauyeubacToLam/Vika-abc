...
class CossackStraightLegMetric extends CossackMetricBase {
  static const double STRAIGHT_LEG_MIN_ANGLE = 160.0; // Lenient threshold for straight leg
    ...
    if (ctx.straightKneeAngle < STRAIGHT_LEG_MIN_ANGLE) {
      addFault(
        FaultRecord(
          ...
          message: 'Bạn đang thu hẹp tư thế, mất tác dụng kéo giãn cơ khép. Hãy giữ thẳng chân còn lại.',
          affectsForm: true,
