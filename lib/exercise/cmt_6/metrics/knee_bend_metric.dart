...
class KneeBendMetric extends Cmt6MetricBase {
  @override
  ...
  void update(Cmt6Context ctx) {
    final isActive = ctx.state == Cmt6State.p3_hastapaadasana ||
        ctx.state == Cmt6State.p10_hastapaadasana_return;
    if (!isActive) return;

    final isKneeBent = ctx.kneeAngle < Cmt6Config.KNEE_STRAIGHT_MIN;
