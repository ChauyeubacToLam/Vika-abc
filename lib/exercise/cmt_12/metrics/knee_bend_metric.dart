...
class KneeBendMetric extends Cmt12MetricBase {
  @override
  ...
  void update(Cmt12Context ctx) {
    final isActive = ctx.state == Cmt12State.p3_hastapaadasana ||
        ctx.state == Cmt12State.p10_hastapaadasana_return;
    if (!isActive) return;

    final isKneeBent = ctx.kneeAngle < Cmt12Config.KNEE_STRAIGHT_MIN;
