...
class KneeBendMetric extends Cmt5MetricBase {
  @override
  ...
  void update(Cmt5Context ctx) {
    final isActive = ctx.state == Cmt5State.p3_hastapaadasana ||
        ctx.state == Cmt5State.p10_hastapaadasana_return;
    if (!isActive) return;

    final isKneeBent = ctx.kneeAngle < Cmt5Config.KNEE_STRAIGHT_MIN;
