...
class KneeSeparationMetric extends ButterflyMetricBase {
  ...
  void update(StretchContext ctx) {
    ...
    double normalizedDiff = yDiff / (ctx.shoulderToHipRatio == 0 ? 1 : ctx.shoulderToHipRatio);
    ...
    if (_asymmetryDebouncer.update(normalizedDiff > KneeSeparationConfig.ASYMMETRY_THRESHOLD)) { 
