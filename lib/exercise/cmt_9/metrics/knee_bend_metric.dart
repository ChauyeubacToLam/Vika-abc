...
class KneeBendMetric extends Cmt9MetricBase {
  @override
  ...
  void update(Cmt9Context ctx) {
    final isActive = ctx.state == Cmt9State.p3_hastapaadasana ||
        ctx.state == Cmt9State.p10_hastapaadasana_return;
    if (!isActive) return;

    final isKneeBent = ctx.kneeAngle < Cmt9Config.KNEE_STRAIGHT_MIN;
