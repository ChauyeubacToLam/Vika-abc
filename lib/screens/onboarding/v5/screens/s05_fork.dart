  ...
  class _S05ForkState extends State<S05Fork> {
    ...
    widget.data.forkRec = _rec;             // ← store full object
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'Bạn hiểu mình rõ nhất — đổi bất cứ lúc nào ở Hồ sơ.',
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _SectionLabel(text: 'Phù hợp khi bạn muốn:'),
                          ...
                          const SizedBox(height: 8),
                          _SectionLabel(text: 'Chưa lý tưởng nếu:'),
                          const SizedBox(height: 8),
                          ...choice.caveats.map(
                            (c) => Padding(
                              padding: const EdgeInsets.only(bottom: 6),
                          ...
                          Container(
                            ...
                            child: Text(
                              '${choice.stat} ${choice.statLabel} · AI kiểm tra form · ${choice.equipment}',
                              style: V5.text(
                                context,
                                size: 11,
                                weight: FontWeight.w600,
